      ...
      <ScrollReveal>
        ...
        <section className="px-8 mb-32 flex flex-col md:flex-row gap-8 lg:gap-16 ">
          <div className="flex-1 flex flex-col pt-8 justify-between flex-start">
            <h1
              id="discover-hero"
              className="text-5xl md:text-7xl font-bold mb-10 tracking-tight font-jakarta"
            >
              {t("discover.title")}
            </h1>
          ...
          <div
            id="discover-video-preview"
            className="flex-1 w-full rounded-[1.5rem] overflow-hidden "
          >
        ...
        <div id="discover-attractions">
          <AttractionsSlider />
        </div>

        {/* Things to do  */}
        <div id="discover-things-to-do">
          <ThingsToDo />
        </div>
      </ScrollReveal>
      <Footer />
