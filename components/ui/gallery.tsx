...
export const PhotoGallery = ({
  ...
  const photos = [
    ...
    },
    {
      ...
      zIndex: 20,
      direction: "right" as Direction,
      src: "/assets/districts/sleman.avif",
    },
    {
      id: 5,
      order: 4,
      ...
      direction: "left" as Direction,
      src: "https://images.unsplash.com/photo-1506748686214-e9df14d4d9d0?auto=format&fit=crop&q=80&w=800",
    },
  ];
  ...
  return (
    <div className="mt-4 relative pb-2">
      ...
      <div className="relative md:mb-8 h-[350px] w-full items-center justify-center lg:flex">
        <motion.div
...
export const Photo = ({
  ...
  return (
    <motion.div
      ...
      tabIndex={0}
    >
      <div className="relative h-full w-full overflow-hidden rounded-3xl shadow-sm bg-gray-100">
        <MotionImage
