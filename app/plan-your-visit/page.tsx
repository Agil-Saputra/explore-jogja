  ...
  return (
    <main className="min-h-screen bg-cream text-gray-900 pt-28 md:pt-48 pb-0 font-jakarta">
      <ScrollReveal>
        ...
        <section
          id="plan-visit-getting-here"
          className="px-8 py-16 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center mt-32"
        >
          {/* Left Column (Image) */}
