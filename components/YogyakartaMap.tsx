    ...
    <div className="relative w-full py-16 px-8 md:py-24 bg-white z-20 overflow-hidden" id="yogyakarta-map">
      ...
      <div className="flex gap-8 mx-auto items-start flex-col md:flex-row">
        ...
        <div className="flex-1 flex flex-col gap-4">
          ...
          <div ref={districtListRef} className="flex flex-col gap-4">
          {Object.entries(DISTRICT_DATA).map(([key, data]) => (
            <div
              key={key}
              className={`district-card flex items-center gap-5 p-4 rounded-2xl border transition-all duration-300 cursor-pointer  ${hoveredId === key
                ? "bg-white border-gray-200 shadow-md scale-[1.01]"
